...
Devise.setup do |config|
  ...
  # config.secret_key = 'b310b8e35222f45f71b14232d05afe4fb336cedd85af'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'test.cgs.develop@gmail.com'
  ...
  # apply to request_keys. config.request_keys = []
  ...
  # config.pepper = 'fe59607c3383fd5e1cd477c431e4ccd9ddb48116553584d40402debcbb'
  ...
  config.timeout_in = Rails.env.production? ? 30.minutes : 15.minutes
  ...
  # :time  = Re-enables login after a certain amount of time (:unlock_in below)
  ...
  # their password is reset. Defaults to true, so a user is
  # signed in automatically after a reset.
  ...
  #  manager.default_strategies(scope: :user).unshift :custom_failure_app
  # end

  # ==> Mountable engine configurations
  # When using Devise inside an engine, `MyEngine`, and this engine
